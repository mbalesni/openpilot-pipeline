...
from model import load_model, ORIGINAL_MODEL


def save_torch_to_onnx(path_to_model):
    torch_model = load_model(ORIGINAL_MODEL)
    ...
    torch.onnx.export(torch_model, (inputs['input_imgs'], inputs['desire'], inputs['traffic_convention'], inputs['initial_state'], {}), path_to_output, export_params=True, opset_version=9, do_constant_folding=False,
                      input_names=['input_imgs', 'desire', 'traffic_convention', 'initial_state'], output_names=['outputs'],
